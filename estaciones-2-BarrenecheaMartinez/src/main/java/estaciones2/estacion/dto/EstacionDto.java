...
public class EstacionDto {
    ...
    public EstacionDto(String nombre, boolean lleno, long dirPostal, BigDecimal latitud, BigDecimal longitud, int bicisDisponibles, int numPuestos) {
        this.nombre = nombre;
        this.lleno = lleno;
